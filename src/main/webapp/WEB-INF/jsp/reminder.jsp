...
<table class="table table-hover">
	...
	<tbody>
		<c:forEach items="${reminderList}" var="reminder">
			...
			<td><a href="/reminder/renew?id=${reminder.id}" ><img src="${pageContext.request.contextPath}/images/renew.jpg" width="20"  height="20"/></a></td>
			<td><a href="/reminder/sendReminderMail?id=${reminder.id}" ><img src="${pageContext.request.contextPath}/images/email.jpg" width="20"  height="20"/>${reminder.user.username}</a></td>
		</c:forEach>
	</tbody>
</table>
